...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Current version number of the AdventureWorks2008 sample database. ', 'SCHEMA', N'dbo', 'TABLE', N'AWBuildVersion', NULL, NULL
GO
